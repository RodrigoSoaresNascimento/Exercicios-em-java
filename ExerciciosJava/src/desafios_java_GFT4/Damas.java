 ...
 * dada a posição de uma dama em um tabuleiro de xadrez vazio (ou seja, um tabuleiro 8 × 8,
 *  com 64 casas), de quantos movimentos, no mínimo, ela precisa para chegar em outra casa do tabuleiro?
 *
 ...
 *  No tabuleiro, as colunas são numeradas da esquerda para a direita de 1 a 8 e as linhas de cima para baixo 
 *  também de 1 a 8. As coordenadas de uma casa na linha X e coluna Y são (X, Y ).
 *
 *	O final da entrada é indicado por uma linha contendo quatro zeros.
 *
 *	Saída
 *	Para cada caso de teste da entrada seu programa deve imprimir uma única linha na saída, 
 * 	contendo um número inteiro, indicando o menor número de movimentos necessários para a 
